...
#pragma config(Sensor, dgtl7,  lAutonClip,     sensorDigitalIn)
#pragma config(Sensor, dgtl8,  rAutonClip,     sensorDigitalIn)
#pragma config(Motor,  port1,           brDrive,       tmotorVex393HighSpeed_HBridge, openLoop, reversed, driveRight)
#pragma config(Motor,  port2,           trDrive,       tmotorVex393HighSpeed_MC29, openLoop, reversed, driveRight)
#pragma config(Motor,  port3,           rGoalMtr,      tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port4,           clawMtr,       tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port5,           rLiftMtr,      tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port6,           lLiftMtr,      tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port7,           chainMtr,      tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port8,           lGoalMtr,      tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port9,           tlDrive,       tmotorVex393HighSpeed_MC29, openLoop, driveLeft)
#pragma config(Motor,  port10,          blDrive,       tmotorVex393HighSpeed_HBridge, openLoop, driveLeft)
...
#include "funcs.h"
#include "srBot1v2 Autons - Unstable.h"
...
void pre_auton()
{
  ...
  SensorValue[rDriveEnc] =
  	SensorValue[lDriveEnc] =
  	SensorValue[chainEnc] =
  	0;

  auton = 0;

  auton += (SensorValue[lAutonClip])
  	? 1
  	: 0;

  auton += (SensorValue[rAutonClip])
  	? 2
  	: 0;
}
